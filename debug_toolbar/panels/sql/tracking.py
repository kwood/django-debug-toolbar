...
class NormalCursorWrapper(BaseCursorWrapper):
    ...
    def _record(self, method, sql, params):
        ...
        if vendor == "postgresql":
            ...
            initial_conn_status = conn.status if hasattr(conn, 'status') else conn.pgconn.status
        ...
        try:
            ...
            if vendor == "postgresql":
                ...
                final_conn_status = conn.status if hasattr(conn, 'status') else conn.pgconn.status
